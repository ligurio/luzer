...
# FIXME: Should be defined in luzer/CMakeLists.txt.
set(ASAN_DSO "asan_with_fuzzer.so")
set(UBSAN_CXX_DSO "ubsan_cxx_with_fuzzer.so")
set(UBSAN_DSO "ubsan_with_fuzzer.so")
...
GEN_BUILD_TARGET("ubsan_cxx"
  ${LIBCLANG_UBSAN_CXX_LIB}
  ${FUZZER_NO_MAIN_LIBRARY}
  "${LIBCLANG_UBSAN_STRIP}"
  ${UBSAN_CXX_DSO}
)
